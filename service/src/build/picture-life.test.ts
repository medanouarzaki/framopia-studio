...
import { pictureLives, type PictureWindow } from './picture-life.js';
 ...
 * consecutive. There is no void between them, layer after layer."* He was shown
 * his own reel built two ways — a picture leaving on the frame the next one
 * arrives, and a picture staying underneath for the length of the next one's
 * fade — and chose the first, so a handover is a cut and there is nothing to
 * select between.
 *
