...
describe('what a client who says nothing gets', () => {
  ...
  it('leaves k2-syndicalia taking every client detail’s standard value', () => {
    ...
    // the image-style palette and lighting fragments. v12 at session 13: the
    // framing axis. None of the fields *this* module answers for has ever been
    // touched by those bumps.
